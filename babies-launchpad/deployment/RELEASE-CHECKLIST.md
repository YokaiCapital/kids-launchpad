...
| Mixed read/write load | tested (bounded) 23 Sep 2026 on the new gateway: 320 reads p95 362 ms, 150 req/s, quotes p95 485 ms, replays exact, restart to ready in 30 s with reconciliation complete | `staging/gateway.mjs` | scratchpad scripts mixed-load-test-ledger.mjs, write-load-test-ledger.mjs; PRIVATE-TEST-STATUS |
