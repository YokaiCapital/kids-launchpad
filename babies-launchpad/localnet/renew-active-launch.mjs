...
import {existsSync,mkdirSync,renameSync,readdirSync,writeFileSync} from 'node:fs';import {join} from 'node:path';import {fileURLToPath} from 'node:url';
const runtime=fileURLToPath(new URL('./.runtime/',import.meta.url));
import {readFileSync} from 'node:fs';import {summarizeIntents} from '../shared/intent-retention.mjs';
